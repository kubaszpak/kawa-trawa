...
async function populateDatabaseWithTestData(connection: Connection) {
	...
	const productMintTea = productRepository.create({
		...
		description:
			"Mentol zawarty w liściach tej rośliny zwiększa produkcję soków żołądkowych oraz ogranicza wydzielanie żółci, tym samym skutecznie a zarazem naturalnie łagodząc wzdęcia, kolki czy skurcze.",
		pathToImage:
			"https://image.freepik.com/free-psd/plastic-bag-foil-pouch-bag-packaging-package-branding-identity_1150-41196.jpg",
		price: 9,
		quantity: 100,
		visibility: true,
	});
	...
	const productGreenTea = productRepository.create({
		...
		name: "Green tee 100g",
		description:
			"Napój przyrządzany wyłącznie z liści herbaty chińskiej (Camellia sinensis), które poddane zostały w czasie przetwarzania jedynie minimalnej oksydacji.",
		pathToImage:
	...
	const productBlackTea = productRepository.create({
		...
		name: "Black tee 100g",
		description:
			"Zawiera dużo teiny, przez co działa pobudzająco. Ma działanie antybakteryjne w układzie pokarmowym i wzmaga wydzielanie soków trawiennych. Zmniejsza ciśnienie krwi, przez co również wystąpienie chorób serca.",
		pathToImage:
			"https://image.freepik.com/free-psd/plastic-bag-foil-pouch-bag-packaging-package-branding-identity_1150-41201.jpg",
		price: 7,
		quantity: 50,
		visibility: true,
	});
