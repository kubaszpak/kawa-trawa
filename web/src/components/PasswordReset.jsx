    ...
    const resetPasswordRequest = () => {
        ...
        axios({
            ...
            .then(response => { //200
                ...
                // error = response.data;
                setError('')
                setSuccess('Sprawdź swój adres ' + resetData.mail + ' w celu potwierdzenia zresetowania hasła.')

                showAlert('success', 'Sprawdź swój adres ' + resetData.mail + ' w celu potwierdzenia zresetowania hasła.')
        ...
        <Grid>
            <Paper style={paperStyle}>
                ...
                <form>
                    ...
                    <TextField style={tfStyle} id="outlined-basic" label="E-mail" variant="outlined" onChange={e => setResetData({ mail: e.target.value })} required />

                    <Button style={buttonStyle} onClick={resetPasswordRequest} variant="outlined">Wyślij email do resetu hasła</Button>
                </form>
            </Paper>
        </Grid>
    )
